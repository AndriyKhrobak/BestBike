...
namespace TitleTurtle.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        //public ActionResult ChooseBike(SearchViewModel model)
        //{
        //    using (var db = new HomeContext())
        //    {
        //        var searchResult = (from Article in db.Articles
        //                            where Article.Sex == model.Sex
        //                                       && Article.Hight == model.Hight
        //                                       && Article.Place == model.Place
        //                                       && Article.MasaRovera == model.MasaRovera
        //                                       && Article.Rama == model.Rama
        //                                       && Article.Speeds == model.Speeds
        //                            select Article).ToList();
